# -*- coding: utf-8 -*-
"""
Created on Thu Apr  7 07:44:06 2022
...
@st.cache
def load_data():
    df_agg = pd.read_csv(r"C:\Users\Bridget\Documents\Youtube\YT_dashboard_ken\archive (2)\Aggregated_Metrics_By_Video.csv").iloc[1:,:]
    df_agg_sub = pd.read_csv(r"C:\Users\Bridget\Documents\Youtube\YT_dashboard_ken\archive (2)\Aggregated_Metrics_By_Country_And_Subscriber_Status.csv")
    df_comments = pd.read_csv(r"C:\Users\Bridget\Documents\Youtube\YT_dashboard_ken\archive (2)\All_Comments_Final.csv")
    df_time = pd.read_csv(r"C:\Users\Bridget\Documents\Youtube\YT_dashboard_ken\archive (2)\Video_Performance_Over_Time.csv")
